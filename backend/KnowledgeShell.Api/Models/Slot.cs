namespace KnowledgeShell.Api.Models
{
    ...
    public class Slot : Identifiable<Guid>
    {
        ...
        public virtual Frame Owner { get; set; }
        public Guid OwnerId { get; set; }

        [HasOne(PublicName = "parent")]
        public virtual Slot Parent { get; set; }
        public Guid? ParentId { get; set; }

        [HasMany(PublicName = "children")]
        public virtual List<Slot> Children { get; set; }
        ...
        public virtual DomainValue Value { get; set; }
        public Guid? ValueId { get; set; }

        [HasOne(PublicName = "production")]
